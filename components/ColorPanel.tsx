...
import { Image as ImageIcon, Link as LinkIcon, MessageSquare, Palette } from 'lucide-react';
...
const ColorPanel: React.FC<ColorPanelProps> = ({ theme, setTheme }) => {
        ...
        <Section title="Canvas & Backgrounds">
           ...
           {isFrosted ? (
             <div className="bg-indigo-50/50 p-4 rounded-2xl border border-indigo-100 mt-2 space-y-1">
                ...
                {/* Fix: headerColor1-3 are now recognized as valid keys of ThemeConfig */}
